                ...
                messages: [
                    {
                        ...
                        3. **重要：如果整个视频的主题就是介绍某一产品、服务、项目或创作者自身内容（例如：产品评测、开箱演示、教程制作、项目展示、创作者自荐等），并且视频内容围绕该主题展开，那么此类内容不应被视为广告段落，除非其中插入了与视频主题无关的第三方商业推广。**
                        4. 在判断广告时，需重点考察是否具有独立的推广意图。如果品牌提及或活动描述是视频核心叙事的自然组成部分（如游戏实况中描述赞助商举办的店内活动），且没有直接引导购买、促销或脱离主题的推广，则不视为广告段落。反之，如果内容包含明确的销售意图、促销信息或与主题无关的第三方推广，则判定为广告。
                        ...
                        7. 只在有明确证据显示独立推广意图时才判定为广告，避免误判正常内容讨论为广告。当内容与视频主题高度融合、无直接促销时，应谨慎判断，优先视为视频内容的一部分。
