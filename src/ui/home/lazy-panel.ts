/**
 * 首页推荐历史弹窗「列表区」面板懒加载桥（只能被动态 import！）
 *
 * 与 src/ui/settings/lazy-panel.js 同样的两个理由：
 ...
 */
import HomeHistoryPanel from './HomeHistoryPanel.vue'
import { createApp, reactive, markRaw } from 'vue'
export const HomeHistoryPanelComponent = HomeHistoryPanel
