const templates = {
    ...
    indexRecommendVideoHistoryPopover: '<div id="[[INDEXRECOMMENDVIDEOHISTORYPOPOVER]]" class="adjustment_popover" popover><div id="[[INDEXRECOMMENDVIDEOHISTORYPOPOVERTITLE]]"><span>首页视频推荐历史记录</span><div id="[[CLEARRECOMMENDVIDEOHISTORYBUTTON]]">清空记录</div></div><div id="indexRecommendVideohistoryContents"><div id="indexRecommendVideohistoryCategories"><ul id="[[INDEXRECOMMENDVIDEOHISTORYCATEGORY]]"><li class="all adjustment_button primary plain">全部</li></ul><ul id="[[INDEXRECOMMENDVIDEOHISTORYCATEGORYV2]]"><li class="all_v2 adjustment_button primary plain">全部·V2</li></ul></div><ul id="[[INDEXRECOMMENDVIDEOHISTORYLIST]]"></ul></div></div>'
}
