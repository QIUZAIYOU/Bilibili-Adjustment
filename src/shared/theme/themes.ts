...
/** 主题定义：colors / shadows 随主题变化，shared（间距/圆角/字号/过渡/层级）三主题一致 */
export interface ThemeDefinition {
    id: string
    label: string
    colors: Record<string, string>
    shadows: Record<string, string>
    shared: typeof sharedTokens
}
/** 主题 id 联合类型（THEMES 的键） */
export type ThemeId = 'night' | 'light' | 'dark'
...
export const THEMES: Record<ThemeId, ThemeDefinition> = { night, light, dark }
