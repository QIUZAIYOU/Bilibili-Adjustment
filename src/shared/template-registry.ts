...
/** 使用报告条目 */
export interface TemplateUsageReportItem {
    name: string
    count: number
    lastUsed: number | null
...
// 模板使用统计
const templateUsageStats = new Map<string, TemplateUsageStats>()
// 模板版本追踪
 ...
 * @returns {string[]}
 */
const extractSelectorsFromTemplate = (template: string): string[] => {
 ...
 */
export function registerTemplate (name: string, template: string, meta: TemplateMeta = {}): void {
 ...
 */
export function registerTemplates (templates: Record<string, string>, metaMap: Record<string, TemplateMeta | undefined> = {}): void {
 ...
 * @param {Object} meta
 */
export function updateTemplate (name: string, newTemplate: string, meta: TemplateMeta = {}): void {
 ...
 * @param {string} name
 */
export function recordTemplateUsage (name: string): void {
 ...
 * @returns {Array}
 */
export function getTemplateUsageReport (): TemplateUsageReportItem[] {
    const report: TemplateUsageReportItem[] = []
 ...
 * @returns {Object}
 */
export function exportTemplateRegistry (): Record<string, unknown> {
 ...
 * @returns {string[]}
 */
export function getUnusedTemplates (): string[] {
    const unused: string[] = []
    templateRegistry.forEach((meta, name) => {
        const stats = templateUsageStats.get(name)
